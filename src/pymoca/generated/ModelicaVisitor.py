...
class ModelicaVisitor(ParseTreeVisitor):
    ...
    def visitElement_modification_or_replaceable(
    ...
    def visitStatement_component_reference(
    ...
    def visitStatement_component_function(
    ...
    def visitPrimary_component_reference(
    ...
    def visitPrimary_output_expression_list(
    ...
    def visitPrimary_function_arguments(
    ...
    def visitComponent_reference_element(
