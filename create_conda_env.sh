...
conda info -a
conda create -n pymola python=3.5 numpy scipy sympy coverage matplotlib gcc cython jupyter
...
pip install casadi antlr4-python3-runtime control coveralls pydot slycot lapack
