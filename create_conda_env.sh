...
conda info -a
conda create -q -n pymola python=3.5 numpy scipy sympy coverage coveralls matplotlib gcc cython jupyter
...
pip install casadi antlr4-python3-runtime control
